...
| configuration.PRODUCER_DATA_SIZE_BYTES | int | `1073741824` | Size of random data generated by the consumer to calculate a checksum in order to simulate some work |
